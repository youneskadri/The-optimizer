...
class FrontController extends AbstractController
{
    ...
    public function front(MatchFRepository $repository, Request $request, ManagerRegistry $doctrine): Response
    {
        ...
        $teams = $doctrine->getRepository(Equipe::class)->getClassementEquipe();
