 ...
 */
final class Version20230305192117 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event DROP type_event_id, CHANGE video type_event VARCHAR(255) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE event ADD type_event_id INT DEFAULT NULL, CHANGE type_event video VARCHAR(255) NOT NULL');
